...
class ArbaInisRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "inis"
    name = f"{project_namespace}-{project_base_name}"
    package_type = "library"

    # Optional metadata
    description = "A C++ library reading/writing settings from/to an .ini(s) file."
    url = "https://github.com/arapelle/arba-inis"
    homepage = "https://github.com/arapelle/arba-inis"
    topics = ("ini", "property-tree")
    license = "MIT"
